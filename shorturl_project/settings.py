...
SECRET_KEY = 'django-insecure-ff+brsvqkj(z@9yn_^cw!gvy^gmvq!41(p^01wqyhn3o^z0uh&'
...
# CELERY_BROKER_URL = "redis://127.0.0.1:6379"  # Update with your Redis configuration
...
# CRONJOBS = [
#     ('*/5 * * * *', 'shorturl_project.task.scrape_nifty_data_task')
# ]
CRONJOBS = [
    ('*/2 * * * *', 'shorturl_project.task.scrape_nifty_data_task')
]
